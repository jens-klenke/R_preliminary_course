...
<ol start = "1">
    <li>Verschaffen Sie sich einen Überblick über den Datensatz<code>mtcars</code> ((dieser ist in base R bereits geladen). Aus wie vielen Variablen besteht er? Welche Klasse haben die einzelnen Variablen?</li>
    <li>Lassen Sie sich folgende Subsets von \texttt{mtcars} ausgeben:</li>
    <ul>
...
<ol start = "1">
    ...
    <li>Schreiben Sie Cod, der die Struktur (siehe <code>?str()</code>) eines Objekts <code>df</code> wiedergibt, sofern <code>df</code> zur Klasse <code>data.frame</code> gehört. Andernfalls soll die Länge des Objekts wiedergegeben werden.</li>
</ol>
