...
1. Erzeugen Sie einen Vektor \texttt{numbers} mit den Elementen $\begin{pmatrix} 4 & 6 & -3 & 2.5 & 18 & \pi &  85 \end{pmatrix}$.

    *Hinweis:* Die Zahl $\pi$ ist in `r r_black` bereits als `pi` vordefiniert.

2. Berechnen Sie das arithmetische und das harmonische Mittel von \texttt{numbers}. 
...
<ol start="4">
    ...
    <liErzeugen Sie einen neuen Vektor <code>characters</code> mit den Elementen \(\begin{pmatrix} a & a & a  & b & b & b & b & c & c \\ \end{pmatrix}\).  Finden Sie dazu heraus wie die Funktion <code>rep()</code> funktioniert und nutzen Sie diese.</li>
...
<ol start="9">
    <li>Erzeugen Sie einen Vektor mit den Elementen \(\begin{pmatrix} 1 & 2 & 3 & a & b \\ \end{pmatrix}\)(Also eine Mischung aus <code>numeric</code> und <code>character</code>). Was passiert? Schreiben Sie einen Kommentar.</li>
</ol>
