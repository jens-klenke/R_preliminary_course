...
## Überschreiben Sie jetzt den Vektor  \texttt{characters}  mit \linebreak  $\begin{pmatrix} x & y & z & x & y & z & x & y & z \\ \end{pmatrix}$. Nutzen Sie wieder die Funktion \texttt{rep()}.
...
Ersetzen Sie jetzt alle `NA`s in der Matrix mit dem Wert $1$. Nutzen Sie dazu die Funktion `is.na()`.
