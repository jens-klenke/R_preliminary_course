...
(Zusatzaufgabe: Führen Sie dieselbe Simulationsstudie mit
Cauchy-verteilten Zufallszahlen (\texttt{rcauchy()}) durch. Was fällt
Ihnen nun auf? Können Sie sich das Ergebnis erklären?)

\hypertarget{zusatz-zeigen-sie-dass-das-integral-uxfcber-die-dichtefunktion-einer-chi215-verteilten-zufallsvariable-1-ist.}{%
\subsection{\texorpdfstring{Zusatz: Zeigen Sie, dass das Integral über
die Dichtefunktion einer \(\chi^2(15)\)-verteilten Zufallsvariable 1
ist.}{Zusatz: Zeigen Sie, dass das Integral über die Dichtefunktion einer \textbackslash chi\^{}2(15)-verteilten Zufallsvariable 1 ist.}}\label{zusatz-zeigen-sie-dass-das-integral-uxfcber-die-dichtefunktion-einer-chi215-verteilten-zufallsvariable-1-ist.}}

(Zum Integrieren in R können Sie \texttt{integrate()} benutzen.)
...
\hypertarget{betrachten-sie-nun-den-aus-den-folien-bekannten-datensatz-mtcars.-regressieren-sie-die-reichweite-mpg-auf-die-getriebeart-am-mit-automatik-0-manuell-1-und-lassen-sie-den-achsenabschnitt-weg.-interpretieren-sie-ihr-ergebnis.}{%
\subsection{\texorpdfstring{Betrachten Sie nun den aus den Folien
bekannten Datensatz \textbf{mtcars}. Regressieren Sie die Reichweite
(\emph{mpg}) auf die Getriebeart (\emph{am} mit Automatik = 0, Manuell =
1) und lassen Sie den Achsenabschnitt weg. Interpretieren Sie ihr
Ergebnis.}{Betrachten Sie nun den aus den Folien bekannten Datensatz mtcars. Regressieren Sie die Reichweite (mpg) auf die Getriebeart (am mit Automatik = 0, Manuell = 1) und lassen Sie den Achsenabschnitt weg. Interpretieren Sie ihr Ergebnis.}}\label{betrachten-sie-nun-den-aus-den-folien-bekannten-datensatz-mtcars.-regressieren-sie-die-reichweite-mpg-auf-die-getriebeart-am-mit-automatik-0-manuell-1-und-lassen-sie-den-achsenabschnitt-weg.-interpretieren-sie-ihr-ergebnis.}}
